            ...
            >
              <div>
                <div className="relative h-52 overflow-hidden bg-gray-200">
                  ...
                  <div className="absolute top-3 right-3 bg-white text-emerald-900 text-xs font-semibold px-2.5 py-1 rounded-full shadow">
                    {proj.status}
                  </div>
                </div>
              ...
              <div className="px-6 pb-6 pt-2 flex items-center justify-between border-t border-gray-100 mt-2">
                <span className="text-xs font-semibold text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-md max-w-[180px] truncate" title={proj.beneficiaries}>
